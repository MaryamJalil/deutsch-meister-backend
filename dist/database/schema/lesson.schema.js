...
const level_schema_js_1 = require("./level.schema.js");
const module_schema_js_1 = require("./module.schema.js");
exports.lessons = (0, pg_core_1.pgTable)('lessons', {
    ...
    levelId: (0, pg_core_1.integer)('level_id')
        .notNull()
        .references(() => level_schema_js_1.levels.id),
    moduleId: (0, pg_core_1.integer)('module_id').references(() => module_schema_js_1.modules.id),
